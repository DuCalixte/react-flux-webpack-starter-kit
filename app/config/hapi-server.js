...
// compiler.apply(new DashboardPlugin((new Dashboard({title: appOid, color: 'cyan', port: webpackPort})).setData));
// compiler.apply(new DashboardPlugin({title: appOid, color: 'cyan', port: webpackPort}));
// compiler.apply(new DashboardPlugin((new Dashboard({title: appOid, color: 'cyan', port: webpackPort}))));
// compiler.apply(new DashboardPlugin({ port: 8090 }));
