...
if (process.env.NOTIFY === 'prompt') {
  const WebpackBuildNotifierPlugin = require('webpack-build-notifier'); // eslint-disable-line global-require
  ...
  const Dashboard = require('webpack-dashboard'); // eslint-disable-line global-require
